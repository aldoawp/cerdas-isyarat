...
export default function IntroPage() {
  ...
  // Data Dialog dengan emoji yang lebih fun
  const dialogues = [
    {
      id: 1,
  ...
  return (
    <div className="page-container relative min-h-screen w-full overflow-hidden">
      ...
      <div
        className="animate-float absolute left-10 top-10 text-brand-yellow/40"
        style={{ animationDelay: '0s' }}
      >
        <CloudIcon className="size-20 md:size-24" />
      </div>
      <div
        className="animate-float absolute bottom-20 right-10 text-brand-yellow/40"
        style={{ animationDelay: '1.5s' }}
      >
        <CloudIcon className="size-24 md:size-32" />
      </div>
      <div className="animate-spin-slow absolute right-20 top-1/4 text-orange-300 opacity-60">
        <StarIcon className="size-10 md:size-12" />
      </div>
      <div
        className="animate-spin-slow absolute bottom-1/3 left-10 text-amber-400 opacity-60"
      ...
      <main className="relative z-10 flex min-h-screen flex-col items-center justify-center p-4">
        ...
        <div className="relative flex w-full max-w-md flex-col items-center">
          ...
          <div
            className="animate-float relative z-10 w-64 cursor-pointer transition-transform duration-200 active:scale-95 md:w-72"
            onClick={handleNext}
          >
            <Image
