...
import { GameHeader } from './components/game-headers';
import { FloatingMascot } from './components/floating.maskot';
import { FillInTheBlankMode } from './components/fill-in-the-blank';
import { MultipleChoiceImageMode } from './components/multiple-choice-image-question';
import { NavigationButtons } from './components/navigation-button';
import { ResultsModal } from './components/result-modal';
import { LeaveConfirmationModal } from './components/leave-confirmation-modals';

// Logika inti dari custom hook
import { useTest } from '@/app/hooks/use-tests';
