        ...
        return (
          ...
          >
            ...
            {hasImage ? (
              ...
              <div className="flex h-20 items-center justify-center rounded-lg bg-gray-100 md:h-24">
                <span className="text-center text-sm font-semibold text-brand-brown-stroke">
                  {option.label ||
                    `Pilihan ${String.fromCodePoint(65 + index)}`}
                </span>
              </div>
            )}
